...
export function ChartsSection({ airCooling, chassisImmersion }: ChartsSectionProps) {
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="text-base">TCO, CAPEX, OPEX Comparison</CardTitle>
                </CardHeader>
                <CardContent>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="text-base">Air Cooling: CAPEX vs OPEX</CardTitle>
                </CardHeader>
                <CardContent>
                    <ResponsiveContainer width="100%" height={200}>
                        <PieChart>
                            <Pie data={airPie} cx="50%" cy="50%" innerRadius={40} outerRadius={80} dataKey="value">
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="text-base">Chassis Immersion: CAPEX vs OPEX</CardTitle>
                </CardHeader>
                <CardContent>
                    <ResponsiveContainer width="100%" height={200}>
                        <PieChart>
                            <Pie data={chassisPie} cx="50%" cy="50%" innerRadius={40} outerRadius={80} dataKey="value">
