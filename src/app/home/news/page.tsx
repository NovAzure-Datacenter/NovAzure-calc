...
const applicationNews: NewsItem[] = [
	{
		...
		content:
			"We've launched a comprehensive analytics dashboard that provides real-time insights into your data center performance, energy efficiency metrics, and carbon footprint tracking. The new dashboard includes customizable widgets, automated reporting, and predictive analytics capabilities.",
	...
	},
	{
		...
		content:
			"We've implemented advanced security measures including multi-factor authentication, role-based access control, and enhanced data encryption. These improvements ensure your sensitive data remains protected while maintaining seamless user experience.",
		author: "NovAzure Team",
		date: "1 week ago",
		category: "application",
		readTime: "2 min read",
	...
	},
	{
		...
		content:
			"Join our exclusive beta testing program for the new NovAzure mobile application. Test cutting-edge features including real-time monitoring, push notifications, and offline capabilities. Limited spots available for early access.",
		author: "NovAzure Team",
		date: "1 week ago",
		category: "application",
		readTime: "1 min read",
	...
	},
	{
		...
		content:
			"Connect your existing tools and systems seamlessly with our new API Integration Hub. Support for popular platforms including Salesforce, Microsoft Dynamics, and custom REST APIs. Streamline your workflow and eliminate data silos.",
		author: "NovAzure Team",
		date: "2 weeks ago",
		category: "application",
		readTime: "4 min read",
	...
	},
	{
		...
		content:
			"New collaborative tools allow team members to work together in real-time on projects, share insights, and coordinate efforts seamlessly. Includes live commenting, version control, and instant notifications.",
		author: "NovAzure Team",
		date: "3 weeks ago",
		category: "application",
		readTime: "2 min read",
	...
	},
	{
		...
		content:
			"Our new reporting engine provides deeper insights with customizable dashboards, automated report generation, and export capabilities in multiple formats including PDF, Excel, and CSV.",
		author: "NovAzure Team",
		date: "1 month ago",
		category: "application",
		readTime: "3 min read",
					...
					<div className="mx-auto max-w-7xl space-y-8">
						...
						<div className="space-y-2">
							...
							<p className="text-muted-foreground">
								Stay informed about NovAzure company news and application
								updates.
							</p>
						</div>
