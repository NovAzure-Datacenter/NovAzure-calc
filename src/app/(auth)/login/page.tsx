...
export default function LoginPage() {
	...
	const userDemo: UserData = {
		name: "John Doe",
		account_type: "seller",
		profile_image: "/images/profile/profile1.jpg",
		company_name: "iceotope",
	};
		...
		<div className="min-h-screen flex flex-col">
			...
			<div className="bg-[#0A4DA2] text-white p-3">
				<div className="max-w-7xl mx-auto">
					<p className="text-sm">
						Now you can log in using your email address instead of a username.
			...
			<div className="flex flex-grow">
								...
								<form onSubmit={handleSubmit} className="space-y-4">
									...
									<div className="flex justify-between text-sm">
										<Link
											...
											className="text-[#0A4DA2] hover:text-[#083d82]"
										>
				...
				<div className="w-1/2 bg-white p-8 flex items-center">
					<div className="w-full max-w-2xl mx-auto space-y-6">
						...
						<div className="bg-[#0A4DA2] text-white rounded-2xl p-8 transform hover:scale-[1.01] transition-all duration-300 shadow-lg">
							<div className="space-y-4">
								...
								<p className="text-lg text-blue-50">
									We empower energy, mobility, and tech companies to scale
						...
						{/* Register Button */}
						<Button className="w-full bg-[#0A4DA2] hover:bg-[#083d82] text-white text-xl py-6 rounded-xl flex items-center justify-center gap-2 transform hover:scale-[1.02] transition-all duration-300">
							Register now
							<svg
								className="w-6 h-6"
								fill="none"
				...
				<div className="container mx-auto px-4">
					...
					<div className="mt-8 pt-8 border-t border-white/20 flex flex-col md:flex-row justify-between items-center">
						...
						<div className="flex gap-4 items-center">
							{/* Social Links */}
							<Link
								href="mailto:contact@novazure.com"
								className="hover:text-gray-300"
							>
