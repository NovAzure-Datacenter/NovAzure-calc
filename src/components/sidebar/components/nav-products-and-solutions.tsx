...
import { getProductsAndSolutionsItems, type AccountType } from "../navigation-items";

interface NavProductsAndSolutionsProps {
	pathname: string;
	user: UserData | null;
	accountType: AccountType;
}

export function NavProductsAndSolutions({ 
	pathname, 
	user: _user, 
	accountType 
}: NavProductsAndSolutionsProps) {
	...
	const productItems = getProductsAndSolutionsItems(accountType);
